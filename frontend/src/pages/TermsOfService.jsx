    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{
          ...
          Terms of <span style={{ color: COLORS.amber }}>Service</span>
        </h1>
        <p style={{
          fontSize: "1.1rem",
          ...
          Welcome to MealBridge. By using our platform, you agree to these dummy terms of service.
        </p>
        <p style={{
          fontSize: "1.1rem",
          color: isLight ? "rgba(15,23,42,0.7)" : "rgba(255,255,255,0.8)",
          ...
          1. Do not misuse the platform. <br/>
          2. Ensure all food donations are safe and within expiry limits. <br/>
          3. Monetary donations are non-refundable in this dummy environment.
        </p>
      </div>
