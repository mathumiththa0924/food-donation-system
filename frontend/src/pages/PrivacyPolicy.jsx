    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{
          ...
          Privacy <span style={{ color: COLORS.amber }}>Policy</span>
        </h1>
        <p style={{
          fontSize: "1.1rem",
          ...
          At MealBridge, your privacy is of utmost importance to us. This is a dummy privacy policy page created for demonstration purposes.
        </p>
        <p style={{
          fontSize: "1.1rem",
          color: isLight ? "rgba(15,23,42,0.7)" : "rgba(255,255,255,0.8)",
          ...
          We do not collect any actual personal data without your consent. All information provided during registration or donation is kept strictly confidential. 
        </p>
      </div>
